<template>
  <div>
    <h2 class="hkf_title text-center mb-4">Accounts Receivable Ledger</h2>
    <div>
      <nav>
            ...
            <tr v-for="(purchase_ledger, index) in purchase_ledgers" :key='index' >
              ...
              <td
                style="
                  ...
                  text-align: center;
                "
                v-if="purchase_ledger.cash && purchase_ledger.due != 0"
              >
                {{ purchase_ledger.product_name }} (Cash),
              ...
              <td
                ...
                "
                v-else-if="
                  purchase_ledger.cash &&
                  purchase_ledger.paid != 0 &&
                  purchase_ledger.balance != 0
                "
              >
                {{ purchase_ledger.supplier_name }}, {{ purchase_ledger.product_name }}
                (Cash)
              </td>
              <td
                style="
              ...
              <td
                ...
                "
                v-else-if="
                  purchase_ledger.bank &&
                  purchase_ledger.paid != 0 &&
                  purchase_ledger.balance != 0
                "
              >
                {{ purchase_ledger.supplier_name }}, {{ purchase_ledger.product_name }} (
                Bank-{{ purchase_ledger.bank }})
              </td>
              <td
                style="
                  border: 1px solid black;
              ...
              <td
                style="
                  ...
                  text-align: center;
                "
                v-else-if="purchase_ledger.bank && purchase_ledger.due != 0"
              >
                {{ purchase_ledger.product_name }} ( Bank-{{ purchase_ledger.bank }}),
                {{ purchase_ledger.supplier_name }}
              </td>
...
export default {
  ...
  methods: {
    ...
    passLedger() {
      ...
      axios
        .post("/api/rp_ledger/pass_ldg", requestData, {
          headers: {
