<template>
  <div>
    <h2 class="hkf_title text-center mb-4">Purchase Ledger</h2>
    <div>
      <nav>
    ...
    <div>
      ...
      <div id="print-container">
        ...
        <label class="hkf_text"> Product: {{ selectedLedger }} </label>
        <div class="row">
...
export default {
  ...
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      ...
      if (!User.hasLoggedIn()) {
        ...
        vm.$router.push({ name: "purchase_ledger" });
      }
    });
  },
  data() {
  ...
  methods: {
    ...
    passLedger() {
      ...
      axios
        .post("/api/purchase_ledger/pass_ldg", requestData, {
          headers: {
