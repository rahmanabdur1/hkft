    ...
    <div class="row">
      <div class="col-md-12 mx-auto">
        <form @submit.prevent="addProject()">
          ...
          <div class="form-group mx-sm-3 col-md-6 mb-2">
            <label for="location" class="hkf_text">Receiver Name</label>
            <input
              type="text"
              class="form-control"
...
export default {
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      ...
      if (!User.hasLoggedIn()) {
        ...
        vm.$router.push({ name: "edit_pay_construction" });
      }
    });
  },
  data() {
  ...
  created() {
    ...
    axios
      .get("/api/pay_construction/" + this.$route.params.id)
      .then((res) => {
        this.form = res.data;
  ...
  methods: {
    ...
    addProject() {
      axios
        .post("/api/construction_pays_update", this.form, {
          headers: {
