      ...
      <div class="col-md-6 mx-auto">
        <form class="form" @submit.prevent="addLand()">
          ...
          <div class="form-group mx-sm-3 mb-2">
            ...
            <input type="file" class="form-control" @change="selectedDocs" />
...
export default {
  ...
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      ...
      if (!User.hasLoggedIn()) {
        ...
        vm.$router.push({ name: "add_purchase_land" });
      }
    });
  },
  data() {
  ...
  methods: {
    ...
    addLand() {
      ...
      axios
        .post("/api/purchase_land_details", formData, {
          headers: {
        ...
        .then((res) => {
          this.$router.push({ name: "all_purchase_land" });
        })
        .catch((error) => {
