  ...
  <div class="row">
    <div class="col-md-12 mx-auto">
      <h2 class="hkf_title mb-2">
        Payment Voucher: <span>{{ form.payment_id }}</span>
      </h2>
      <div class="row">
        <div class="col-md-10 mx-auto">
          ...
          <div id="print-container">
            ...
            <h3 style="text-align: center">{{ form.selectedProject }}</h3>
            ...
            >
              ...
              <tr style="height: 135px">
                <td style="border: 1px solid black; text-align: center">
                  ...
                  <span
                    v-if="form.product_name == 'land'"
                    style="display: block; margin-left: 1rem; font-weight: 300"
                    >( {{ form.product_name }} ) - Ledger No: {{ form.ledger_no }}
                  </span>
                   <span v-else style="display: block; margin-left: 1rem; font-weight: 300"
            ...
            <h5>Note: {{ form.payment_details }}</h5>
          </div>
          <h5>Document:</h5>
          <button
            type="button"
          ...
          <div>
            <div class="container mt-5">
              ...
              >
                ...
                <tr>
                  <td class="GJournal">{{ form.product_name }}</td>
                ...
                <tr>
                  ...
                  <td class="GJournal"></td>
                  <td class="GJournal">{{ journals.paid }}</td>
                </tr>
                <tr>
                  <td class="GJournal">Accounts Payable</td>
                  <td class="GJournal"></td>
                  <td class="GJournal">{{ journals.due }}</td>
                </tr>
              </table>
            </div>
          </div>
          <div>
            <router-link
              :to="{ name: 'pay_payable' }"
              v-if="showDueBtn && !existPayableShow"
              type="button"
              class="btn action mt-2"
              style="width: 100px"
              >Clear Due
            ...
            <router-link
              :to="{ name: 'edit_pay_payable', params: { id: hasPayable } }"
              v-if="showDueBtn && existPayableShow"
              type="button"
              class="btn action mt-2"
              style="width: 100px"
...
export default {
  ...
  created() {
    ...
    axios
      .get("/api/purchased_journal/getjournal/" + this.$route.params.id)
      .then((res) => {
    ...
    axios
      ...
      .then((res) => {
        ...
        axios
          .get("/api/getPayableID/" + this.payment_id)
          .then((res) => {
            if (res.data.id != "empty") {
              this.hasPayable = res.data.id.id;
              this.existPayableShow = true;
            } else {
              this.existPayableShow = false;
            }
          })
          .catch((err) => {});
        if (parseInt(this.form.payment_due) != 0) {
          this.showDueBtn = true;
        } else {
          this.showDueBtn = false;
        }
        this.total = parseFloat(parseFloat(this.journals.paid).toFixed(2));
        this.number = parseInt(this.journals.paid);
        this.convertToWord();
