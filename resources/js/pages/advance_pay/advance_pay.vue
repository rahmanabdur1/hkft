<template>
  <div>
    <h2 class="text-center mb-4 hkf_title">Add Extra Payment</h2>
    ...
    <div class="row">
      <div class="col-md-12 mx-auto">
        <form @submit.prevent="addProject()">
          ...
          <div class="form-group mx-sm-3 col-md-6 mb-2">
            <label for="projectName" class="hkf_text">Client ID</label>
...
export default {
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      ...
      if (!User.hasLoggedIn()) {
        ...
        vm.$router.push({ name: "advance_pay" });
      }
    });
  },
  data() {
  ...
  methods: {
    ...
    addProject() {
      axios
        .post("/api/advance_pay", this.form, {
          headers: {
