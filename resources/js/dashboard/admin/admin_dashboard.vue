        ...
        <div class="col-xl-3 col-md-6 mb-4">
          <div class="card border-left-warning shadow h-100 py-2">
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <div class="font-weight-bold text-warnings text-uppercase mb-1">
                    Receipt Due
                  </div>
                  <div class="h5 mb-0 font-weight-bold text-gray-800">
                    {{ receiptDue }} tk
...
export default {
  ...
  created() {
    ...
    axios.get("/api/fetchDashboardProject").then((res) => {
  ...
  methods: {
    dailyAccounts() {
      ...
      axios
        .get("/api/calculateDailyGetExpense")
        .then((res) => {
          this.totalExpense = res.data;
        })
        .catch((err) => {
      ...
      axios
        .get("/api/calculateDailyGetSalary")
        .then((res) => {
          this.totalSalary = res.data;
          console.log(res.data);
        })
    ...
    weeklyAccounts() {
      ...
      axios
        .get("/api/calculateWeeklyGetExpense")
        .then((res) => {
          this.totalExpense = res.data;
        })
        .catch((err) => {
      ...
      axios
        .get("/api/calculateWeeklyGetSalary")
        .then((res) => {
          this.totalSalary = res.data;
          console.log(res.data);
        })
