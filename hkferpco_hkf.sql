...
CREATE TABLE `admins` (
  ...
  `guard` varchar(255) NOT NULL DEFAULT 'admin',
...
CREATE TABLE `advance_pays` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `basic_date` varchar(255) DEFAULT NULL,
  `client_name` varchar(255) DEFAULT NULL,
  `client_id` varchar(255) DEFAULT NULL,
  `selectedProject` varchar(255) DEFAULT NULL,
  `selectedBuilding` varchar(255) DEFAULT NULL,
...
(546, 'not appicable', 'UdLIn-75333', 'Rod', '0', '-4493000', 'Cash', NULL, '2024-03-21', '0', '-4493000', '2024-03-21 03:37:35', '2024-03-21 03:40:25', 'Installation-1673548UdLIn-75333', '2023-2024'),
(547, 'not appicable', 'UdLIn-75333', 'Rod', '10000', '0', 'Cash', NULL, '2024-03-23', '0', '-4483000', '2024-03-21 03:38:42', '2024-03-21 03:38:42', 'Due-4777639egzwQ-85397', '2023-2024');
...
CREATE TABLE `bank_ledgers` (
  ...
  `account_type` varchar(255) DEFAULT NULL,
  `financialYear` varchar(255) DEFAULT NULL,
  `receipt_paid` varchar(255) DEFAULT NULL,
  `receipt_due` varchar(255) DEFAULT NULL,
...
(548, 'ফারজানা মন্ডল', 'DPAEI26078', '1A', NULL, NULL, 'Cash', '', '2024-03-07', NULL, NULL, '2024-03-19 08:37:40', '2024-03-19 08:37:40', 'Installation-3476014DPAEI26078', '2023-2024', '5000', '0', '0'),
...
(553, 'not appicable', 'UdLIn-75333', 'Rod', '-7000', '0', 'Cash', '', '2024-03-21', NULL, '-7000', '2024-03-21 03:37:35', '2024-03-21 03:37:35', 'Installation-1673548UdLIn-75333', '2023-2024', NULL, NULL, '0'),
(554, 'not appicable', 'UdLIn-75333', 'Rod', '-10000', '0', 'Cash', '', '2024-03-23', NULL, '-17000', '2024-03-21 03:38:42', '2024-03-21 03:38:42', 'Due-4777639egzwQ-85397', NULL, NULL, NULL, '0');
...
CREATE TABLE `clients` (
  ...
  `husban_wife_name` varchar(255) DEFAULT NULL,
  ...
  `temprorary_location` varchar(255) DEFAULT NULL,
  `temprorary_post_office` varchar(255) DEFAULT NULL,
  `temprorary_thana` varchar(255) DEFAULT NULL,
  `temprorary_district` varchar(255) DEFAULT NULL,
  `tin` varchar(255) DEFAULT NULL,
  `phone` varchar(255) DEFAULT NULL,
  `email` varchar(255) DEFAULT NULL,
  `nid_img` varchar(255) DEFAULT NULL,
  `passport_img` varchar(255) DEFAULT NULL,
  `tin_img` varchar(255) DEFAULT NULL,
  `clientUnderProject` varchar(255) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `profile_photos` varchar(255) DEFAULT NULL,
...
(133, 'হুমায়ুন কবীর', 'null', 'null', 'null', 'null', 'null', 'null', 'null', 'null', 'null', 'null', 'null', 'null', 'null', 'null', 'null', 'null', 'null', '01732170160', NULL, 'null', 'null', 'null', 'Unique Tower', '2024-01-30 08:29:59', '2024-01-30 08:29:59', 'AdminPanel/img/1793608961243586.gif', 'UT-001', 'UT', '1'),
(134, 'ফারজানা মন্ডল', 'null', 'null', 'null', 'null', 'null', 'null', 'null', 'null', 'null', 'null', 'null', 'null', 'null', 'null', 'null', 'null', 'null', '01712711703', 'null', 'AdminPanel/img/1790268146788094.jpeg', NULL, NULL, 'Unique Tower', '2024-01-30 08:30:34', '2024-01-30 08:30:34', NULL, 'UT-002', 'UT', '1'),
...
CREATE TABLE `construction_histories` (
  ...
  `note` varchar(255) DEFAULT NULL,
  `construction_id` varchar(255) DEFAULT NULL,
...
CREATE TABLE `construction_pays` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `construction_id` varchar(255) DEFAULT NULL,
  `physical_voucher` varchar(255) NOT NULL,
  `selectedPaymentType` varchar(255) NOT NULL,
  `cash_bank_account` varchar(255) DEFAULT NULL,
  `bank_cheque_no` varchar(255) DEFAULT NULL,
  `bank_cheque_date` varchar(255) DEFAULT NULL,
...
(67, '2022-04-16', 'হুমায়ুন কবীর', 'DT-001', 'Dream Tower', 'DT', '1000000', 'construction', '2024-02-02 09:58:03', '2024-02-02 12:36:49', 'BREgk93908', '00', 'Cash', NULL, NULL, NULL, NULL, '', 'documents/65bd36411cf2eহুমায়ুন কবির DT-001.pdf'),
...
(75, '2023-08-12', 'মোঃ মাসুদ রানা', 'UT-005', 'Unique Tower', 'UT', '400000', 'plan design & pilling    ( HK sir )', '2024-02-02 10:17:09', '2024-02-02 10:17:09', 'GPllG45540', '201', 'Cash', NULL, NULL, NULL, NULL, '', ''),
(76, '2024-01-05', 'মোঃ মাসুদ রানা', 'UT-005', 'Unique Tower', 'UT', '500000', 'plan design & pilling  HK SIR', '2024-02-02 10:18:23', '2024-02-02 10:18:23', 'GPllG45540', '205', 'Cash', NULL, NULL, NULL, NULL, '', ''),
(77, '2024-01-04', 'মোঃ বজলুল রহমান', 'UT-006', 'Unique Tower', 'UT', '150000', 'plan design & pilling', '2024-02-02 10:22:07', '2024-02-02 10:48:23', 'GPllG45540', '208', 'Cash', NULL, NULL, NULL, NULL, '', ''),
(78, '2024-01-04', 'মোঃ শাহজাহান', 'UT-011', 'Unique Tower', 'UT', '100000', 'plan design & pilling  HK SIR', '2024-02-02 10:23:59', '2024-02-02 10:48:38', 'GPllG45540', '204', 'Cash', NULL, NULL, NULL, NULL, '', ''),
...
(82, '2022-03-06', 'এস এম জাকারিয়া', 'DT-004', 'Dream Tower', 'DT', '50000', 'HK', '2024-02-02 10:53:05', '2024-02-02 10:53:05', 'BREgk93908', '00', 'Cash', NULL, NULL, NULL, NULL, '', ''),
(83, '2022-03-06', 'এস এম জাকারিয়া', 'DT-004', 'Dream Tower', 'DT', '100000', 'HK', '2024-02-02 10:54:00', '2024-02-02 11:10:02', 'BREgk93908', '022', 'Cash', NULL, NULL, NULL, NULL, '', ''),
...
(85, '2022-10-06', 'আনোয়ার হোসেন', 'DT-005', 'Dream Tower', 'DT', '150000', 'construction', '2024-02-02 10:56:02', '2024-02-02 10:56:02', 'BREgk93908', '98', 'Cash', NULL, NULL, NULL, NULL, '', ''),
...
(88, '2023-02-28', 'এস এম জাকারিয়া', 'DT-004', 'Dream Tower', 'DT', '200000', 'construction', '2024-02-02 11:05:40', '2024-02-02 11:05:40', 'BREgk93908', '158', 'Cash', NULL, NULL, NULL, NULL, '', ''),
...
(90, '2023-06-18', 'এস এম জাকারিয়া', 'DT-004', 'Dream Tower', 'DT', '100000', 'cash biplob', '2024-02-02 11:07:22', '2024-02-02 11:07:22', 'BREgk93908', '00', 'Cash', NULL, NULL, NULL, NULL, '', ''),
...
(255, '2024-01-13', 'আবুল কালাম আজাদ', 'DGC7-045', 'Dhanmondi garden city', 'DGC7', '100000', 'Plan & Design', '2024-02-27 22:15:35', '2024-02-27 22:15:35', 'gADCQ85962', '030', 'Cash', NULL, NULL, NULL, NULL, '', '');
...
CREATE TABLE `consume_stocks` (
  ...
  `consumeQuantity` varchar(255) DEFAULT NULL,
  `product_name` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
(17, 'Jakir', NULL, '01793607623', 'Engineer', '18000', 'HsANH-51271', '2024-02-03 12:35:28', '2024-02-03 12:35:28', 'Dream Tower', '', 'DT'),
...
CREATE TABLE `expenses` (
  ...
  `financialYear` varchar(255) DEFAULT NULL,
  `basic_date` varchar(255) DEFAULT NULL,
  `selectedPaymentType` varchar(255) DEFAULT NULL,
  `cash_bank_account` varchar(255) DEFAULT NULL,
  `selectedProject` varchar(255) DEFAULT NULL,
  `product_name` varchar(255) DEFAULT NULL,
  `bank_cheque_no` varchar(255) DEFAULT NULL,
...
(52, '2023-2024', '2024-02-15', 'Cash', NULL, 'Dhanmondi garden city', 'ttt', NULL, NULL, NULL, NULL, '600', 'bqdzI-28449', '2024-02-21 09:04:12', '2024-02-21 09:05:05', 'DGC6', 'documents/65d611210b6942764816c-c12c-432c-ab0b-e9f78fbf45fd.jpg', 'null', '123');
...
CREATE TABLE `inventories` (
  ...
  `property_project` varchar(255) DEFAULT NULL,
  `property_details` varchar(255) DEFAULT NULL,
  `property_status` varchar(255) NOT NULL,
  `property_amount` varchar(255) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `property_type` varchar(255) DEFAULT NULL,
  `sub_property_type` varchar(255) DEFAULT NULL,
  `property_id` varchar(255) DEFAULT NULL,
  `location` varchar(255) DEFAULT NULL,
  `squareft` varchar(255) DEFAULT NULL,
  `floor_level` varchar(255) DEFAULT NULL,
  `size` varchar(255) DEFAULT NULL,
  `building_name` varchar(255) DEFAULT NULL,
  `owner` varchar(255) DEFAULT NULL,
  `daag_no` varchar(255) DEFAULT NULL,
  `sub_property_id` varchar(255) DEFAULT NULL,
...
CREATE TABLE `managers` (
  ...
  `username` varchar(255) NOT NULL,
  `email` varchar(255) NOT NULL,
  `guard` varchar(255) NOT NULL DEFAULT 'manager',
  `password` varchar(255) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `payable_journals` (
  ...
  `payee_name_type` varchar(255) DEFAULT NULL,
  `due` varchar(255) DEFAULT NULL,
  `cash` varchar(255) DEFAULT NULL,
  `bank` varchar(255) DEFAULT NULL,
  ...
  `paid` varchar(255) DEFAULT NULL,
  `payable_date` varchar(255) DEFAULT NULL,
  `financialYear` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `project` varchar(255) DEFAULT NULL,
...
(397, 'UdLIn-75333', 'not appicable', 'Debit', '4483000', 'Cash', NULL, 'Credit', NULL, '4483000', '2024-03-21', '2023-2024', '2024-03-21 03:37:35', '2024-03-21 03:37:35', 'Dhanmondi garden city', 'Rod', 'DGC4');
...
CREATE TABLE `payment_vouchers` (
  ...
  `payee_tin` varchar(255) DEFAULT NULL,
  ...
  `per_unit_price` varchar(255) NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `account_type` varchar(255) DEFAULT NULL,
  `initian_total_amount` varchar(255) DEFAULT NULL,
  `initial_qty` varchar(255) DEFAULT NULL,
...
(437, '2023-2024', '2024-03-21', 'Cash', 'null', 'not appicable', '', '', '0000000', 'null', 'null', 'null', '', '17000', 'UdLIn-75333', '', '', 'Rod', '50', '90000', '4500000', '4483000', 'Dhanmondi garden city', 'ton', '12', '2024-03-21 03:37:35', '2024-03-21 03:40:25', 'Installation-1673548UdLIn-75333', '4500000', '50', '0', NULL, 'DGC4');
...
CREATE TABLE `pay_payables` (
  ...
  `payment_id` varchar(255) NOT NULL,
  `payment_due` varchar(255) DEFAULT NULL,
  `second_payment_due` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `account_type` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(141, '2023-2024', '2024-03-21', 'Cash', NULL, 'not appicable', 'Rod', NULL, NULL, NULL, NULL, '10000', 'UdLIn-75333', '4493000', '4483000', '2024-03-21 03:38:42', '2024-03-21 03:38:42', 'Due-4777639egzwQ-85397');
...
CREATE TABLE `pay_receivables` (
  ...
  `account_type` varchar(255) DEFAULT NULL,
  `due` varchar(255) DEFAULT NULL,
  `second_due` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(30, '2023-2024', '2024-03-14', 'Cash', NULL, 'ফারজানা মন্ডল', '1A', NULL, NULL, NULL, NULL, '2995000', 'DPAEI26078', 'Due-2785528ZBIeF-65576', '2995000', '0', '2024-03-19 08:39:39', '2024-03-19 08:39:39'),
...
CREATE TABLE `projects` (
  ...
  `land_amount` varchar(255) DEFAULT NULL,
  `average_flat_size` varchar(255) DEFAULT NULL,
  `flore_area_size` varchar(255) DEFAULT NULL,
  `building_height` varchar(255) DEFAULT NULL,
  `architact_drawing` varchar(255) DEFAULT NULL,
...
(55, 'Unique Tower', 'Shahjahan market', 'in-progress', '2024-01-30 08:28:06', '2024-02-21 09:10:50', 'logo/65d6125bf29d7SD4 (16-3-17 to aRC.Arif.dwg', '01725061831', '10 katha', '1299', '5000', '10', 'documents/65d6127a7e443New Microsoft Word Document (1).docx', 'UT'),
...
(58, 'PEACE TOWER', 'Hazaribagh Dhaka', 'on-hold', '2024-02-06 22:23:31', '2024-02-06 22:23:31', '', '01725061831', '20 katha', '1200', '5000', '...', '', 'PT');
...
CREATE TABLE `project_members` (
  ...
  `share_number` varchar(255) DEFAULT NULL,
...
(430, 'UdLIn-75333', 'Debit', 'Rod', '4500000', 'not appicable', 'Credit', '4483000', 'Cash', NULL, 'Credit', NULL, '17000', '2024-03-21', '2023-2024', '2024-03-21 03:37:35', '2024-03-21 03:37:35', 'Dhanmondi garden city', 'DGC4');
...
CREATE TABLE `purchase_lands` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `land_office` varchar(255) DEFAULT NULL,
  `moujar` varchar(255) DEFAULT NULL,
  `thana` varchar(255) DEFAULT NULL,
  `district` varchar(255) DEFAULT NULL,
  `owner_name` varchar(255) DEFAULT NULL,
  `holding_number` varchar(255) DEFAULT NULL,
  `land_class` varchar(255) DEFAULT NULL,
  `ledger_no` varchar(255) DEFAULT NULL,
...
(7, 'dfdsf', 'dfdsfds', 'dsfdsf', 'dsfsdf', 'dsfdsf', 'sdfdsf', 'dsfdsf', 'fdsfds', 'dsfdsf', '2023-09-13 02:19:51', '2024-02-26 10:55:51', 'documents/65dcc2973aa89tytytyty.jpg');
...
(404, 'not appicable', 'UdLIn-75333', 'Rod', '7000', '4493000', 'Cash', NULL, '2024-03-21', '2024-03-21 03:37:35', '2024-03-21 03:37:35', '4500000', 'undefined', '0', '4500000', '2023-2024');
...
CREATE TABLE `purchase_returns` (
  ...
  `payment_id` varchar(255) DEFAULT NULL,
  `supplier_name` varchar(255) DEFAULT NULL,
  `per_unit_price` varchar(255) DEFAULT NULL,
  `max_qty` varchar(255) DEFAULT NULL,
  `return_qty` varchar(255) DEFAULT NULL,
  `payment_due` varchar(255) DEFAULT NULL,
  `return_amount` varchar(255) DEFAULT NULL,
  `remaining_due` varchar(255) DEFAULT NULL,
  `date` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `receipt_journals` (
  ...
  `client_name` varchar(255) DEFAULT NULL,
  `client_name_type` varchar(255) DEFAULT NULL,
  `due` varchar(255) DEFAULT NULL,
  `cash` varchar(255) DEFAULT NULL,
  `bank` varchar(255) DEFAULT NULL,
  `cash_type` varchar(255) DEFAULT NULL,
...
(125, 'DPAEI26078', 'Credit', '1A', '3000000', 'ফারজানা মন্ডল', 'Debit', '0', 'Cash', NULL, 'Debit', NULL, '3000000', '2024-03-07', '2023-2024', '2024-03-19 08:35:19', '2024-03-19 08:35:19', 'Dhanmondi garden city', 'DGC4'),
...
CREATE TABLE `receipt_vouchers` (
  ...
  `payees_account_no` varchar(255) DEFAULT NULL,
  `payment_receipt_details` varchar(255) DEFAULT NULL,
  `client_id` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `product_amount` varchar(255) NOT NULL,
  `due` varchar(255) NOT NULL,
  `initial_total_amount` varchar(255) DEFAULT NULL,
  `account_type` varchar(255) DEFAULT NULL,
  `building_name` varchar(255) DEFAULT NULL,
  `property_id` varchar(255) DEFAULT NULL,
  `selected_label` varchar(255) DEFAULT NULL,
  `sub_property_id` varchar(255) DEFAULT NULL,
  `property_type` varchar(255) DEFAULT NULL,
  `payment_status` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(131, '2023-2024', '2024-03-07', 'Cash', '', 'ফারজানা মন্ডল', 'Dhanmondi garden city', '', '', '01712711703', '1A', 'null', 'null', 'null', '', '3000000', 'DPAEI26078', 'documents/65f9a2a7baf65Aerobics_Sprint1 (1).pdf', '', '', '', 'DGC4-001', '2024-03-19 08:35:19', '2024-03-19 08:37:40', '3000000', '0', '3000000', 'Installation-3476014DPAEI26078', 'DGC4', 'mXEFM-54020', 'flat', 'hvnZQ-391785', 'others', NULL),
...
(125, 'ফারজানা মন্ডল', 'DPAEI26078', '1A', '0', '2995000', 'Cash', NULL, '2024-03-07', '0', NULL, 'Installation-3476014DPAEI26078', '2023-2024', '2024-03-19 08:35:19', '2024-03-19 08:35:19'),
...
CREATE TABLE `salaries` (
  ...
  `paid_month` varchar(255) DEFAULT NULL,
  `paid_year` varchar(255) DEFAULT NULL,
  `employee_id` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `employee_name` varchar(255) DEFAULT NULL,
...
(99, 'ফারজানা মন্ডল', 'DPAEI26078', '1A', '3000000', '0', 'Cash', NULL, '2024-03-07', 'DGC4-001', '0', '-3000000', '2023-2024', '2024-03-19 08:35:19', '2024-03-19 08:35:19'),
...
CREATE TABLE `stock_journals` (
  ...
  `consume_quantity` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `stock_transfers` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `fromProject` varchar(255) DEFAULT NULL,
  `fromBuilding` varchar(255) DEFAULT NULL,
  `basic_date` varchar(255) DEFAULT NULL,
